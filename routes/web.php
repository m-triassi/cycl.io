...
Route::post('/purchase-order', [\App\Http\Controllers\PurchaseOrderController::class, "store"])->middleware(['auth']);
Route::put('/purchase-order/{id}', [\App\Http\Controllers\PurchaseOrderController::class, "update"])->middleware(['auth']);
